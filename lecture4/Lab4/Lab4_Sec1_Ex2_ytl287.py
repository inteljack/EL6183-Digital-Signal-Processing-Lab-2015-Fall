...
# Open wave file (mono)
wave_file_name = 'author_stereo.wav'
...
output_block = [0 for n in range(0, CHANNELS*BLOCKSIZE)]
...
for i in range(0, num_blocks):
    ...
    for n in range(0, BLOCKSIZE):
        ...
        # output_block[2*n] = input_tuple[n] * math.cos(2*math.pi*n*f0/RATE + theta)
        # output_block[2*n+1] = input_tuple[n] * math.cos(2*math.pi*n*f0/RATE + theta)
